...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="main">
                <div class="page-header largest parallax custom text-center mb0" style="background-image:url(assets/images/page-header-bg.jpg)" data-0="background-position:50% 50%;" data-top-bottom="background-position:50% 100%">
                    <div class="container-fluid">
                        <h1 data-300-top="opacity:1;" data-top-bottom="opacity:0.4;">About Me</h1>
                ...
                <div class="table-row">
                    <div class="table-cell cell-image smaller overlay-container"  style="background-image:url(assets/images/backgrounds/aboutme/bg1.jpg)">
                    </div><!-- End .table-cell -->
                    <div class="table-cell cell-content larger bg-dark border text-muted">
                        <div class="table-cell-wrapper">
                            <header class="title-block mb35">
                                <h2 class="title custom2 text-white">My <span class="light text-custom">Education</span></h2>
                            </header>
                            <div class="row">
                                <div class="col-xs-6 col-xss-12">
                                    <div class="aboutme-section">
                                        <h4 class="text-white">Junior High School <small class="highlight custom">(2002-2006)</small></h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero facilis itaque aperiam, labore possimu mole.</p>
                                    </div><!-- End .aboutme-section -->
                                </div><!-- End .col-xs-6 -->

                                <div class="col-xs-6 col-xss-12">
                                    <div class="aboutme-section">
                                        <h4 class="text-white">Senior University <small class="highlight custom">(2006-2010)</small></h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero facilis itaque aperiam, labore possimu mole.</p>
                                    </div><!-- End .aboutme-section -->
                                </div><!-- End .col-xs-6 -->
                            </div><!-- End .row -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-container">
                                        <h4 class="progress-title text-muted">Sass &amp; Gulp <span class="text-white">75%</span></h4>
                                    ...
                                    <div class="progress-container">
                                        <h4 class="progress-title text-muted">HTML &amp; CSS <span class="text-white">85%</span></h4>
                                        <div class="progress progress-xs">
                                    ...
                                    <div class="progress-container">
                                        <h4 class="progress-title text-muted">jQuery <span class="text-white">95%</span></h4>
                                        <div class="progress progress-xs">
                                ...
                                <div class="col-sm-6">
                                    <div class="progress-container">
                                        <h4 class="progress-title text-muted">Javascript <span class="text-white">90%</span></h4>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-animate custom" role="progressbar" data-width="90" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                    ...
                                    <div class="progress-container">
                                        <h4 class="progress-title text-muted">Node js <span class="text-white">65%</span></h4>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-animate custom" role="progressbar" data-width="65" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                                    ...
                                    <div class="progress-container">
                                        <h4 class="progress-title text-muted">Wordpress <span class="text-white">95%</span></h4>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-animate custom" role="progressbar" data-width="95" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                                <span class="sr-only">95% Complete</span>
                                            </div><!-- End .progress-bar -->
                ...
                <div class="bg-wrapper pt60 pb30">
                    <div class="container-fluid">
                        <header class="title-block">
                            <h2 class="title custom2 text-center">What do <span class="light text-custom">I Offer?</span></h2>
                        </header>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom wow zoomIn" data-wow-delay="0.15s">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom wow zoomIn" data-wow-delay="0.3s">
                                        <i class="fa fa-eye"></i>
                                    </div><!-- End .service-icon -->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom wow zoomIn" data-wow-delay="0.45s">
                ...
                <div class="mb65 mb55-sm"></div><!-- margin -->
                
                <div class="container-fluid text-center">
                    <header class="title-block">
                        <h2 class="title custom2 text-center">My <span class="light text-custom">Portfolio</span></h2>
                    </header>
                ...
                <div class="container-fluid">
                    <div class="portfolio-row">
                        <div id="portfolio-item-container" class="popup-gallery max-col-4" data-layoutmode="fitRows">
                            ...
                            <div class="portfolio-item illustration wordpress">
                                <figure>
                            ...
                            <div class="portfolio-item web-design logo-design">
                                <figure>
                                    <img src="assets/images/portfolio/grid/item9.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/item9.jpg" data-thumb="assets/images/portfolio/grid/item9.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">Lorem ipsum dolor sit amet, consec tetur adipis</a></h3>
                            ...
                            <div class="portfolio-item logo-design illustration">
                                <figure>
                                    <img src="assets/images/portfolio/grid/item10.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/item10.jpg" data-thumb="assets/images/portfolio/grid/item10.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">Lorem ipsum dolor sit amet, consec tetur adipis</a></h3>
                            ...
                            <div class="portfolio-item logo-design">
                                <figure>
                                    <img src="assets/images/portfolio/grid/item11.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/item11.jpg" data-thumb="assets/images/portfolio/grid/item11.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">Lorem ipsum dolor sit amet, consec tetur adipis</a></h3>
                            ...
                            <div class="portfolio-item web-design illustration marketing">
                                <figure>
                                    <img src="assets/images/portfolio/grid/item12.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/item12.jpg" data-thumb="assets/images/portfolio/grid/item12.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">Lorem ipsum dolor sit amet, consec tetur adipis</a></h3>
                    ...
                    <div class="pagination-wrapper text-center">
                        <nav class="pagination-container min-width">
                            <a href="#" class="btn btn-custom min-width">Read more</a>
                        </nav>
                ...
                <div class="bg-wrapper pt55 pb50 pt45-sm pb40-sm">
                    <div class="container-fluid">
                        <header class="title-block">
                            <h2 class="title custom2 text-center">My <span class="light text-custom">Testimonials</span></h2>
                        </header>
                ...
                <div class="container-fluid">
                    <header class="title-block">
                        <h2 class="title custom2 text-center">My <span class="light text-custom">Clients</span></h2>
                    </header>
                ...
                <div class="callout custom mb0">
                    <div class="container-fluid">
                        ...
                        <div class="right">
                            <a href="#" class="btn btn-custom2 min-width">Hire me now</a>
                        </div><!-- End .right -->
                    </div><!-- End .container-fluid -->
                </div><!-- End .callout -->
            </div><!-- End .main -->
