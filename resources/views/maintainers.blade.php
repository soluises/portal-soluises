    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="main">
                ...
                <div class="container-fluid">
                    <h2 class="title custom2 text-center">Visit our Office</h2>
                    <p class="title-desc text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis eos ducimus qui sunt vero, aut, aliquid distinctio, dolore mque susci.</p>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>Facere esse accusantium possimus saepe et maxime, dignissimos alias aspernatur quibusdam laborum, quis, quisquam exercitationem enim aliquam rerum ipsum nulla est ullam numquam? Aliquam, deleniti ab quibusdam est laboriosam nostrum.</p>
                            <p>Consequatur quibusdam quae, tempora quod, rem, asperiores sed laborum eos, deleniti ullam fugiat tenetur. Nostrum eos inventore quasi tenetur suscipit, cupiditate aliquam? At volup tionem enim aliquam rerum ipsum.</p>
                        </div><!-- End .col-md-6 -->
                 ...
                 <div class="mb45 mb35-sm mb25-xs"></div><!-- margin -->
                ...
                <div class="mb40 mb20-xs"></div><!-- margin -->
                ...
                <div class="container-fluid">
                    <div class="callout text-center">
                        ...
                        <a href="#" class="btn btn-custom2 min-width">Go to Action</a>
                    </div><!-- End .callout -->
                </div><!-- End .container-fluid -->

                <div class="mb10 mb0-xs"></div><!-- margin -->
                
                <div class="container-fluid">
                    <h2 class="title custom2 text-center">Creative Team</h2>
                    <p class="title-desc text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis eos ducimus qui sunt vero, aut, aliquid distinctio, dolore mque susci.</p>

                    <div class="swiper-container team-carousel-4col">
                ...
                <div class="mb35"></div><!-- margin -->

                <div class="container-fluid">
                    <div class="bg-white bordered col-xs-12 pt55 pb50">
                        <h2 class="title custom2 text-center mb30">Testimonials</h2>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial">
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi atque numquam accusamus nulla molestiae totam eveniet doloribus molestias esse veritatis, aspernatur, consectetur veniam corrupti exercitationem nam laboriosam nihil explicabo alias.</p>
                                                <cite>Desmond Mason <span>Ceo of e2themes</span></cite>
                                            </blockquote>
                                        </div><!-- End .testimonial -->
                                    </div><!-- End .swiper-slide -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial">
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi atque numquam accusamus nulla molestiae totam eveniet doloribus molestias esse veritatis, aspernatur, consectetur veniam corrupti exercitationem nam laboriosam nihil explicabo alias.</p>
                                                <cite>Jason Richardson <span>Ceo of Bold Tem.</span></cite>
                                            </blockquote>
                                        </div><!-- End .testimonial -->
                                    </div><!-- End .swiper-slide -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial">
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi atque numquam accusamus nulla molestiae totam eveniet doloribus molestias esse veritatis, aspernatur, consectetur veniam corrupti exercitationem nam laboriosam nihil explicabo alias.</p>
                                                <cite>Stromile Swift <span>Ceo of Bootstrap</span></cite>
                                            </blockquote>
                                        </div><!-- End .testimonial -->
                                    </div><!-- End .swiper-slide -->
                                </div><!-- End .swiper-wrapper -->
                        ...
                        <div class="testimonials-thumbs-wrapper">
                            <div class="swiper-container testimonials-thumbs-carousel">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="assets/images/testimonials/user1.jpg" alt="portfolio item">
                                    </div><!-- End .swiper-slide -->

                                    <div class="swiper-slide">
                                        <img src="assets/images/testimonials/user2.jpg" alt="portfolio item">
                                    </div><!-- End .swiper-slide -->

                                    <div class="swiper-slide">
                                        <img src="assets/images/testimonials/user3.jpg" alt="portfolio item">
                                    </div><!-- End .swiper-slide -->

                                    <div class="swiper-slide">
                                        <img src="assets/images/testimonials/user4.jpg" alt="portfolio item">
                                    </div><!-- End .swiper-slide -->

                                    <div class="swiper-slide">
                                        <img src="assets/images/testimonials/user5.jpg" alt="portfolio item">
                                    </div><!-- End .swiper-slide -->

                                    <div class="swiper-slide">
                                        <img src="assets/images/testimonials/user6.jpg" alt="portfolio item">
                                    </div><!-- End .swiper-slide -->
                                </div><!-- End .swiper-wrapper -->
                ...
                <div class="mb50 mb35-xs"></div><!-- margin -->

                <div class="container-fluid">
                    <h2 class="title custom2 text-center">Our Clients</h2>
                    <p class="title-desc text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis eos ducimus qui sunt vero, aut, aliquid distinctio, dolore mque susci.</p>

                    <div class="swiper-container clients-carousel">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
