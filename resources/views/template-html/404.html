        ...
        <div id="wrapper">
            ...
            <div class="main">
                <div class="page-header largest parallax custom text-center" style="background-image:url(assets/images/page-header-bg.jpg)" data-0="background-position:50% 50%;" data-top-bottom="background-position:50% 100%">
                    <div class="container-fluid">
                        <h1 data-300-top="opacity:1;transform:scale(1);" data-top-bottom="opacity:0.4;transform:scale(1.9);">404</h1>
                ...
                <div class="error-page text-center">
                    <div class="container-fluid">
                        ...
                        <p>We're sorry, the page you requested cannot be found. Please go back to home page.</p>
                        <a href="index.html" class="btn btn-custom2 min-width">Back to Home</a>
                    </div><!-- End .container-fluid -->
                </div><!-- End .error-page -->
            </div><!-- End .main -->
