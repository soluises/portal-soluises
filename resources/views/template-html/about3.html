...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="main">
                <div class="page-header largest parallax custom2 text-center" style="background-image:url(assets/images/page-header-bg.jpg)" data-0="background-position:50% 50%;" data-top-bottom="background-position:50% 100%">
                    <div class="container-fluid">
                        <h1 data-300-top="opacity:1;" data-top-bottom="opacity:0.4;">About Us</h1>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="title dark">Our <span class="light text-custom2">History</span></h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat, officiis, ad repudiandae beatae, temporibus quibusdam corporis amet libero ratione voluptate ex? Aliquid molestiae ea, recusandae autem reprehenderit esse blanditiis enim.</p>
                            <blockquote>
                                <p>Facere esse accusantium possimus saepe et maxime, dignissimos alias aspernatur quibusdam laborum, quis, quisquam exercitationem enim aliquam rerum ipsum.</p>
                                <cite>Jason Richard</cite>
                            </blockquote>
                            <p>Fugit amet nostrum corporis earum natus velit, optio voluptate harum laborum eveniet, voluptatem doloribus animi soluta. Ex doloremque vero maxime, labore odit saepe, suscipit, in error eveniet earum omnis sed.</p>
                        </div><!-- End .col-md-6 -->

                        <div class="clearfix mb10 visible-xs visible-sm"></div><!-- margin -->

                        <div class="col-md-6">
                            <div class="row row-sm custom-gallery">
                                <div class="col-xs-4">
                                    <div class="mt20"></div><!-- margin -->

                                    <a class="custom-link" href="assets/images/portfolio/grid/item9.jpg" data-thumb="assets/images/portfolio/grid/item9.jpg">
                                        <img src="assets/images/portfolio/grid/item9.jpg" alt="Item">
                                    </a>

                                    <a class="custom-link" href="assets/images/portfolio/grid/item11.jpg" data-thumb="assets/images/portfolio/grid/item11.jpg">
                                        <img src="assets/images/portfolio/grid/item11.jpg" alt="Item">
                                    </a>
                                </div><!-- End .col-xs-4 -->

                                <div class="col-xs-4">
                                    <a class="custom-link" href="assets/images/portfolio/grid/item3.jpg" data-thumb="assets/images/portfolio/grid/item3.jpg">
                                        <img src="assets/images/portfolio/grid/item3.jpg" alt="Item">
                                    </a>

                                    <a class="custom-link" href="assets/images/portfolio/grid/item8.jpg" data-thumb="assets/images/portfolio/grid/item8.jpg">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <a class="custom-link" href="assets/images/portfolio/grid/item5.jpg" data-thumb="assets/images/portfolio/grid/item5.jpg">
                                        <img src="assets/images/portfolio/grid/item5.jpg" alt="Item">
                                    </a>

                                    <a class="custom-link" href="assets/images/portfolio/grid/item12.jpg" data-thumb="assets/images/portfolio/grid/item12.jpg">
                ...
                <div class="mb50 mb60-sm"></div><!-- margin -->

                <div class="bg-wrapper pt55 pb25">
                    <div class="container-fluid">
                        <header class="title-block">
                            <h2 class="title dark text-center">Popular <span class="light text-custom2">Services</span></h2>
                            <p class="title-desc text-center">We create the best products for you. Nostrum eos inventore quasi tenetur suscipit, cupiditate aliquam maxime, dignissimos alias aspe.</p>
                        </header>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow rotateIn">
                                        <i class="fa fa-diamond"></i>
                                    </div><!-- End .service-icon -->
                                    <h3 class="service-title"><a href="#">Web Design</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-md-3 -->

                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow rotateIn" data-wow-delay="0.15s">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow rotateIn" data-wow-delay="0.3s">
                                        <i class="fa fa-eye"></i>
                                    </div><!-- End .service-icon -->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow rotateIn" data-wow-delay="0.45s">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    ...
                                    <h3 class="service-title"><a href="#">Marketing</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-md-3 -->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    ...
                                    <h3 class="service-title"><a href="#">SEO</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-md-3 -->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    ...
                                    <h3 class="service-title"><a href="#">Finance</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-md-3 -->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="service icon-left">
                                    ...
                                    <h3 class="service-title"><a href="#">Help</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-md-3 -->
                        </div><!-- End .row -->
                ...
                <div class="mb45"></div><!-- margin -->
                
                <div class="container-fluid">
                    <header class="title-block">
                        <h2 class="title dark text-center">Our <span class="light text-custom2">Team</span></h2>
                        <p class="title-desc text-center">We create the best products for you. Nostrum eos inventore quasi tenetur suscipit, cupiditate aliquam maxime, dignissimos alias aspe.</p>
                    </header>

                    <div class="swiper-container team-carousel-fullnav">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="member text-center">
                                    <div class="member-top">
                                        <figure>
                                            <img src="assets/images/team/member1.jpg" alt="Member Name">
                                        </figure>
                                    ...
                                    <h3 class="member-title"><a href="#">Daxton Levi</a> <small>(Ceo)</small></h3>
                            ...
                            <div class="swiper-slide">
                                <div class="member text-center">
                                    <div class="member-top">
                                        <figure>
                                            <img src="assets/images/team/member2.jpg" alt="Member Name">
                                        </figure>
                                        <div class="social-icons">
                                            <a href="#" class="social-icon" title="Facebook"><i class="fa fa-facebook"></i></a>
                                            <a href="#" class="social-icon" title="Twitter"><i class="fa fa-twitter"></i></a>
                                    ...
                                    <h3 class="member-title"><a href="#">Aria Veras</a> <small>(Marketing)</small></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit osam error quo.</p>
                                </div><!-- End .member -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="member text-center">
                                    <div class="member-top">
                                        <figure>
                                            <img src="assets/images/team/member3.jpg" alt="Member Name">
                                        </figure>
                                        <div class="social-icons">
                                            <a href="#" class="social-icon" title="Facebook"><i class="fa fa-facebook"></i></a>
                                            <a href="#" class="social-icon" title="Twitter"><i class="fa fa-twitter"></i></a>
                                    ...
                                    <h3 class="member-title"><a href="#">Barack Soia</a> <small>(Designer)</small></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit osam error quo.</p>
                                </div><!-- End .member -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="member text-center">
                                    <div class="member-top">
                                        <figure>
                                            <img src="assets/images/team/member4.jpg" alt="Member Name">
                                        </figure>
                                        <div class="social-icons">
                                            <a href="#" class="social-icon" title="Facebook"><i class="fa fa-facebook"></i></a>
                                            <a href="#" class="social-icon" title="Twitter"><i class="fa fa-twitter"></i></a>
                                    ...
                                    <h3 class="member-title"><a href="#">Sam Youras</a> <small>(Developer)</small></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit osam error quo.</p>
                                </div><!-- End .member -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="member text-center">
                                    <div class="member-top">
                                        <figure>
                                            <img src="assets/images/team/member5.jpg" alt="Member Name">
                                        </figure>
                                        <div class="social-icons">
                                            <a href="#" class="social-icon" title="Facebook"><i class="fa fa-facebook"></i></a>
                                            <a href="#" class="social-icon" title="Twitter"><i class="fa fa-twitter"></i></a>
                                    ...
                                    <h3 class="member-title"><a href="#">Jason Desulo</a> <small>(Jr. Designer)</small></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit osam error quo.</p>
                                </div><!-- End .member -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="member text-center">
                                    <div class="member-top">
                                        <figure>
                                            <img src="assets/images/team/member6.jpg" alt="Member Name">
                                        </figure>
                                        <div class="social-icons">
                                            <a href="#" class="social-icon" title="Facebook"><i class="fa fa-facebook"></i></a>
                                            <a href="#" class="social-icon" title="Twitter"><i class="fa fa-twitter"></i></a>
                                    ...
                                    <h3 class="member-title"><a href="#">Richard Hawk</a> <small>(Jr. Developer)</small></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit osam error quo.</p>
                                </div><!-- End .member -->
                            </div><!-- End .swiper-slide -->
                    ...
                    </div><!-- End .team-carousel-4col -->
                </div><!-- End .container-fluid -->

                <div class="mb45"></div><!-- margin -->

                <div class="bg-wrapper pt55 pb50 pt45-sm pb40-sm">
                    <div class="container-fluid">
                        <header class="title-block">
                            <h2 class="title dark text-center">See <span class="light text-custom2">Testimonials</span></h2>
                            <p class="title-desc text-center">We create the best products for you. Nostrum eos inventore quasi tenetur suscipit, cupiditate aliquam maxime, dignissimos alias aspe.</p>
                        </header>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="testimonial">
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi atque numquam accusamus nulla molestiae totam eveniet doloribus molestias esse veritatis, aspernatur, consectetur veniam corrupti exercitationem nam laboriosam nihil explicabo alias.</p>
                                                <cite>James Richard Jr. <span>Ceo of Boss Inc.</span></cite>
                                            </blockquote>
                                        </div><!-- End .testimonial -->
                                    </div><!-- End .swiper-slide -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial">
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi atque numquam accusamus nulla molestiae totam eveniet doloribus molestias esse veritatis, aspernatur, consectetur veniam corrupti exercitationem nam laboriosam nihil explicabo alias.</p>
                                                <cite>Susan Doe Dawso <span>Ceo of Google</span></cite>
                                            </blockquote>
                                        </div><!-- End .testimonial -->
                                    </div><!-- End .swiper-slide -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial">
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi atque numquam accusamus nulla molestiae totam eveniet doloribus molestias esse veritatis, aspernatur, consectetur veniam corrupti exercitationem nam laboriosam nihil explicabo alias.</p>
                                                <cite>Johanson Smith <span>Ceo of Eonythemes</span></cite>
                                            </blockquote>
                                        </div><!-- End .testimonial -->
                                    </div><!-- End .swiper-slide -->
                                </div><!-- End .swiper-wrapper -->
                ...
                <div class="mb50 mb40-sm"></div><!-- margin -->

                <div class="container-fluid">
                    <header class="title-block">
                        <h2 class="title dark text-center">Our <span class="light text-custom2">Clients</span></h2>
                        <p class="title-desc text-center">We create the best products for you. Nostrum eos inventore quasi tenetur suscipit, cupiditate aliquam maxime, dignissimos alias aspe.</p>
                    </header>
                ...
                <div class="mb60 mb50-xs"></div><!-- margin -->
            </div><!-- End .main -->
