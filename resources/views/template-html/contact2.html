        ...
        <div id="wrapper">
            ...
            <div class="main">
                <div class="page-header largest parallax custom text-center" style="background-image:url(assets/images/page-header-bg.jpg)" data-0="background-position:50% 50%;" data-top-bottom="background-position:50% 100%">
                    <div class="container-fluid">
                        <h1 data-300-top="opacity:1;transform:scale(1);" data-top-bottom="opacity:0.4;transform:scale(1.9);">Contact us</h1>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <h2 class="title custom2 text-center">Get in touch</h2>
                            ...
                            <div class="mb70 mb60-xs"></div><!-- margin -->
                            
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="location-info text-center">
                                        <div class="location-icon custom2">
                                        ...
                                        <div class="social-icons">
                                            <a href="#" class="social-icon circle" title="Facebook"><i class="fa fa-facebook"></i></a>
                                            <a href="#" class="social-icon circle" title="Twitter"><i class="fa fa-twitter"></i></a>
                                            <a href="#" class="social-icon circle" title="Github"><i class="fa fa-github"></i></a>
                                            <a href="#" class="social-icon circle" title="Linkedin"><i class="fa fa-linkedin"></i></a>
                                            <a href="#" class="social-icon circle" title="Flickr"><i class="fa fa-flickr"></i></a>
                                        </div><!-- End .social-icons -->
                                ...
                                <div class="col-sm-4">
                                    <div class="location-info text-center">
                                        ...
                                        <div class="social-icons">
                                            ...
                                            <a href="#" class="social-icon circle" title="Twitter"><i class="fa fa-twitter"></i></a>
                                            <a href="#" class="social-icon circle" title="Github"><i class="fa fa-github"></i></a>
                                            <a href="#" class="social-icon circle" title="Google +"><i class="fa fa-google-plus"></i></a>
                                            <a href="#" class="social-icon circle" title="Flickr"><i class="fa fa-flickr"></i></a>
                                        </div><!-- End .social-icons -->
                                    </div><!-- End .location-info -->
                                </div><!-- End .col-sm-4 -->
