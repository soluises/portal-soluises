        ...
        <div id="wrapper">
            ...
            <div class="main">
                <div class="page-header largest parallax custom text-center" style="background-image:url(assets/images/page-header-bg.jpg)" data-0="background-position:50% 50%;" data-top-bottom="background-position:50% 100%">
                    <div class="container-fluid">
                        <h1 data-300-top="opacity:1;transform:scale(1);" data-top-bottom="opacity:0.4;transform:scale(1.9);">FaQs</h1>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="clearfix mb40 mb30-xs visible-sm visible-xs"></div><!-- margin -->

                        <aside class="col-md-3 sidebar faqs-sidebar">
                            <div class="widget">
                                <h3 class="widget-title">FaQs Categories</h3>
                                <ul class="faqs-cat-list">
                                    <li>
                                        <a href="#">FaQs Group Name</a>
                                    </li>
                                    <li>
                                        <a href="#">Lorem ipsum dolor sit amet.</a>
                                    </li>
                                    <li>
                                        <a href="#">Assumenda iste quius ias.</a>
                                    </li>
                                    <li>
                                        <a href="#">Usto fugit dolor qu?</a>
                                    </li>
                                </ul>
                            </div>
                        </aside>
                ...
                <div class="mb80 mb70-sm"></div><!-- margin -->
            </div><!-- End .main -->
