    ...
    <body>  
        ...
        <div id="wrapper">
            ...
            <div class="main">
                ...
                <div class="table-row">
                    <div class="table-cell cell-image" style="background-image:url(assets/images/backgrounds/services2/bg1.jpg)">
                        <h2 class="text-white text-center text-shadow mb0 wow zoomIn">Our Services</h2>
                    </div><!-- End .table-cell -->
                    ...
                    <div class="table-cell cell-content bg-custom text-white">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow zoomIn">
                                        <i class="fa fa-diamond"></i>
                                    </div><!-- End .service-icon -->
                                    <h3 class="service-title text-white"><a href="#">Web Design</a></h3>
                            ...
                            <div class="col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow zoomIn" data-wow-delay="0.15s">
                                        <i class="fa fa-edit"></i>
                                    </div><!-- End .service-icon -->
                                    <h3 class="service-title text-white"><a href="#">Advertisement</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-sm-6 -->
                        </div><!-- End .row -->
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow zoomIn" data-wow-delay="0.1s">
                                        <i class="fa fa-eye"></i>
                                    </div><!-- End .service-icon -->
                                    <h3 class="service-title text-white"><a href="#">Social Media</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-sm-6 -->
                            ...
                            <div class="col-sm-6">
                                <div class="service icon-left">
                                    <div class="service-icon custom2 wow zoomIn" data-wow-delay="0.25s">
                                        <i class="fa fa-cogs"></i>
                                    </div><!-- End .service-icon -->
                                    <h3 class="service-title text-white"><a href="#">Support</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                                </div><!-- End .service -->
                            </div><!-- End .col-sm-6 -->
                        </div><!-- End .row -->
                ...
                <div class="table-row no-border">
                    <div class="table-cell cell-content bg-custom2 text-white">
                        <div class="mb10"></div><!-- margin -->

                        <div class="row">
                            <div class="col-sm-6">
                                <div class="service icon-left reverse">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="service icon-left reverse">
                                    <div class="service-icon custom wow zoomIn" data-wow-delay="0.1s">
                                        <i class="fa fa-eye"></i>
                                    </div><!-- End .service-icon -->
                                    <h3 class="service-title text-white"><a href="#">Social Media</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                            ...
                            <div class="col-sm-6">
                                <div class="service icon-left reverse">
                                    <div class="service-icon custom wow zoomIn" data-wow-delay="0.25s">
                                        <i class="fa fa-cogs"></i>
                                    </div><!-- End .service-icon -->
                                    <h3 class="service-title text-white"><a href="#">Support</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consec tetur adipi sunt nisi id magni dignis simos reaque.</p>
                    ...
                    <div class="table-cell cell-image" style="background-image:url(assets/images/backgrounds/services2/bg2.jpg)">
                        <h2 class="text-white text-center text-shadow mb0 wow zoomIn">Our Services</h2>
                    </div><!-- End .table-cell -->
                </div><!-- End .table-row -->

                <div class="table-row no-border">
                    <div class="table-cell cell-image" style="background-image:url(assets/images/backgrounds/services2/bg3.jpg)">
                        <h2 class="text-white text-center text-shadow mb0 wow zoomIn">Our Services</h2>
                    </div><!-- End .table-cell -->
